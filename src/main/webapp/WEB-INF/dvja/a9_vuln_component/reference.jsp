<div class="markdown">
    ...
    *
    [https://www.rapid7.com/db/modules/exploit/multi/http/struts2\_content\_type_ognl](https://www.rapid7.com/db/modules/exploit/multi/http/struts2_content_type_ognl)
</div>