  ...
  <div class='row'>
    <div class='col-md-12'>
      ...
      <div class='row'>
        ...
        <div class='col-md-9'>
          <h3><strong>WSTG-INPV-20
            : </strong> Deserialization Vulnerability</h3>

          <h4>Scenario</h4>
          <div class='markdown'>* [Check deserialized strings](<s:url action="bespoke/serialize"/>)</div>
          <h4>Overview</h4>
          <%--                    <div class="markdown">Applications frequently redirect users to other pages, or use internal forwards in a similar manner. Sometimes the target page is specified in an unvalidated parameter, allowing attackers to choose the destination page.--%>
