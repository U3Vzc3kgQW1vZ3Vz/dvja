<div class='markdown'>
    ...
    prevalent, particularly in legacy code. They are often found in SQL, LDAP, Xpath, or NoSQL queries; OS commands; XML
    parsers, SMTP Headers, program arguments, etc. Injection flaws are easy to discover when examining code, but
    frequently hard to discover via testing. Scanners and fuzzers can help attackers find injection flaws.
    ...
    **Example Scenario**: The application uses untrusted data in the construction of the following vulnerable SQL call:
    ...
    Injection flaws are not limited to SQL backed features only, other components may be vulnerable to injection flaws
    such as:
